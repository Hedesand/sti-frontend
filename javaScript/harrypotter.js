...
var parentsdieQ = {
  ...
  answers: ["Killed by a Hyppogriff", "Killed in a broom accident", "Shot by a scared muggle", "Killed by the dark lord"],
  correctAnswer: "Killed by the dark lord",
};
var QuidditchQ = {
  question: "What position does Harry play on his Quidditch team?",
  answers: ["Keeper", "Seeker", "Beater", "Chaser"],
  correctAnswer: "Seeker",
};
var DracoQ = {
  question:
    "Why doesn't Draco like Harry?",
  answers: ["He did not share his food with him", "He did not accept his handshake", "He did not accept his handshake", "He mocked him and his father"],
  correctAnswer: "He did not accept his handshake",
};
var sortinghatQ = {
  question: "Which houses did the sorting hat consider putting Harry in?",
  answers: ["Hufflepuff and Gryffindor", "Slytherin and Hufflepuff", "Gryffindor and Slytherin", "Gryffindor and Ravenclaw"],
  correctAnswer: "Gryffindor and Slytherin",
};
var BasiliskQ = {
...
var lavatoryQ = {
  question:
    "In the first book, what creature was released in the girl's lavatory?",
  answers: ["Dragon", "Three-headed dog", "Troll", "Basilisk"],
  correctAnswer: "Troll",
};
var VoldemortQ = {
  question:
    "What was Lord Voldemort's original name?",
  answers: ["Volten Riddle", "Timothy Riddle", "Tom Riddle", "Vixen Riddle"],
  correctAnswer: "Tom Riddle",
};
var HermioneQ = {
  question: "What did Hermione use to get to all her classes in the third book?",
  answers: ["Time Machine", "Time Mover", "Time Turner", "Time Teaser"],
