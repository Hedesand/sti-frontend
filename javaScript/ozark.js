...
// question objects
var NameQ = {
  question: "What last name does Wendy use while working with Sam?",
  answers: ["Davidson", "Davis", "Davidson-Byrde", "Byrde"],
  correctAnswer: "Davis",
};
var SilverbergQ = {
  question: "Gary Silverberg lives on what floor?",
  answers: ["53rd", "83rd", "8th", "80th"],
  correctAnswer: "80th",
};
var FBIQ = {
  question:
    "What name is NOT associated with the undercover FBI agent watching Marty?",
  answers: ["Petty", "Ray", "Roy", "Robert"],
  correctAnswer: "Ray",
};
var gentlemanQ = {
  question: "What is the name of the gentleman living in the basement of the Byrde family's new home?",
  answers: ["Buddy", "Jacob", "Bubba", "Bobby"],
  correctAnswer: "Buddy",
};
var RuthWyattQ = {
  question:
    "How is Ruth related to Wyatt?",
  answers: ["They Are Not Actually Related", "His Cousin", "His Sister", "His Aunt"],
  correctAnswer: "his cousin",
};
var TuckQ = {
  question:
    "What does Tuck give Jonah when they first meet?",
  answers: ["A Knife", "A Fishing Rod", "A Rock", "A Book"],
  correctAnswer: "A Knife",
};
var icecreamQ = {
  question:
    "What flavor of ice cream does Charlotte request?",
  answers: ["Pistachio", "Mint Chocolate Chip", "Mint", "Butter Pecan"],
  correctAnswer: "Pistachio",
};
var photographsQ = {
  question: "Who goes inside the Byrde home to take photographs?",
  answers: ["Jacob", "Ash", "Darlene", "Bobby"],
  correctAnswer: "Ash",
};
